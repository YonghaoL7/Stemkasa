...
function websdkready() {
  ...
  var CLIENT_ID = "CiEY4OcpRaG9daJkLOUZcA";
  /**
   ...
   */
  var CLIENT_SECRET = "ELKNuSk0NHattEpVcZ3xaAwrKq6S5lAa";

  // some help code, remember mn, pwd, lang to cookie, and autofill.
  document.getElementById("display_name").value = "default-name"

  document.getElementById("meeting_number").value = "9985373488";
    // testTool.getCookie("meeting_number");
  document.getElementById("meeting_pwd").value = "123";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "C:/Users/14044/Downloads/STEMKasa Project - Zoom API/ZoomAPI/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "C:/Users/14044/Downloads/STEMKasa Project - Zoom API/ZoomAPI/CDN/meeting.html?" +
